                            ...
                            <div class="lg:col-span-2">
                                ...
                                <div>
                                    ...
                                    <div class="flex space-x-4">
                                        ...
                                        <!-- LinkedIn -->
                                        <a href="https://www.linkedin.com/in/jeremiah-brown-realtor" target="_blank" rel="noopener noreferrer" class="w-10 h-10 bg-white/5 border border-white/10 rounded-xl flex items-center justify-center text-white/60 hover:text-secondary hover:border-secondary/30 hover:bg-secondary/5 transition-all duration-300 group" title="Connect on LinkedIn">
                                            <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
